...
namespace SyntheticLegacyApp.Configuration
{
    ...
    {
        // VIOLATION cr-dotnet-0123: API keys embedded in source code (demo placeholders only)
        private const string StripeApiKey    = "PLACEHOLDER_STRIPE_API_KEY_FROM_CONFIGURATION";
        private const string SendGridApiKey  = "PLACEHOLDER_SENDGRID_API_KEY_FROM_CONFIGURATION";
